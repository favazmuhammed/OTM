...
def get_args():
    ...
    parent_parser.add_argument('--test_data_path', type=str, default='faces_emore')
...
def add_task_arguments(parser):
    ...
    parser.add_argument('--include_pose', action='store_true')
    parser.add_argument('--include_quality', action='store_true')
    return parser